package com.hedvig.logged_in.claims.ui
...
class ClaimsFragment : BaseTabFragment() {
    ...
    private val baseMargin: Int by lazy { resources.getDimensionPixelSize(appR.dimen.base_margin) }
    ...
    private fun bindData(commonClaimsData: CommonClaimQuery.Data) {
        ...
        setupLargeTitle(
            appR.string.CLAIMS_TITLE,
            appR.font.circular_bold,
            backgroundColor = requireContext().compatColor(appR.color.off_white)
        )
        ...
        when (commonClaimsData.insurance().status()) {
            InsuranceStatus.ACTIVE -> {
                ...
                commonClaimCreateClaimButton.setHapticClickListener {
                    ...
                    // TODO show to HonestyPledgeBottomSheet and navigate fix navigation to chat
